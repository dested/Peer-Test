...
global.MediaConnection = require('./mediaconnection');
global.DataConnection = require('./dataconnection');
global.Peer = require('./peer');
global.RTCPeerConnection = require('./adapter').RTCPeerConnection;
global.RTCSessionDescription = require('./adapter').RTCSessionDescription;
global.RTCIceCandidate = require('./adapter').RTCIceCandidate;
global.Negotiator = require('./negotiator');
global.util = require('./util');
global.BinaryPack = require('js-binarypack');
...
function Peer(id, options) {
  ...
  if (options.host === '/') {
    options.host = global.location.hostname;
  }
  // Set path correctly.
  if (options.path[0] !== '/') {
...
var util = {
  ...
  browser: (function() {
    if (global.mozRTCPeerConnection) {
      return 'Firefox';
    } else if (global.webkitRTCPeerConnection) {
      return 'Chrome';
  ...
  supports: (function() {
    ...
    var sctp = false;
    var onnegotiationneeded = !!global.webkitRTCPeerConnection;
...
if (typeof global != 'undefined') {
  BlobBuilder = module.exports.BlobBuilder = global.WebKitBlobBuilder ||
    global.MozBlobBuilder || global.MSBlobBuilder || global.BlobBuilder;
}
