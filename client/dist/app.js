...
System.register("game/client", ["angular2/core", 'rxjs/Rx'], function(exports_3, context_3) {
    "use strict";
                    ...
                    this.socket.on('set:id', function (data) {
                        ...
                        peer.on('connection', function (conn) {
                            ...
                            conn.on('data', function (d) {
                                ...
                                _this.messageEmitter.next({ id: conn.peer, message: d });
                            });
                        });
                    });
                    this.socket.on('rooms', function (data) {
                        rooms = data;
                        _this.roomEmitter.next(rooms);
                    });
...
System.register("layout/roomManager/RoomManager", ['angular2/core', "layout/windowComponent/WindowComponent", "game/client"], function(exports_4, context_4) {
    "use strict";
    var __moduleName = context_4 && context_4.id;
    var core_4, WindowComponent_1, client_1;
    var RoomManager;
    return {
        setters:[
            function (core_4_1) {
        ...
        execute: function() {
            RoomManager = (function () {
                ...
                __decorate([
                    core_4.Input(), 
                    __metadata('design:type', String)
                ], RoomManager.prototype, "clientId", void 0);
                RoomManager = __decorate([
                    core_4.Component({
                        ...
                        providers: [client_1.GameClient]
                    }), 
                    __metadata('design:paramtypes', [client_1.GameClient])
                ], RoomManager);
                return RoomManager;
            }());
...
System.register("main", ['angular2/platform/browser', "layout/Layout", 'angular2/http', "game/client"], function(exports_6, context_6) {
    "use strict";
    var __moduleName = context_6 && context_6.id;
    var browser_1, Layout_1, http_1, client_2;
    var Main;
    return {
        setters:[
